...
export default {
  ...
  // Color
  brandPrimary: platform === "ios" ? "rgb(239,139,97)" : "rgb(239,139,97)",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  tabBarTextSize: platform === "ios" ? 18 : 18,
  ...
  subtitleColor: platform === "ios" ? "#333" : "#fff",
  titleFontColor: platform === "ios" ? "#333" : "#fff",
